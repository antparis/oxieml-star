...
# ============================================================
DATA_DIR = "data"
OUTPUT_JSON = "double_validation_v2_result.json"

DATASETS = {
    "mandelbrot": "fractal_mandelbrot.csv",   # z -> z^2 + c          (holomorphic)
    "tricorn":    "fractal_tricorn.csv",      # z -> conj(z)^2 + c    (anti-holomorphic)
    "wm_damped":  "wm_damped.csv",            # damped oscillation    (dissipative -> anti)
    "wm_larmor":  "wm_larmor.csv",            # Larmor precession     (unitary -> holo)
    "wm_rabi":    "wm_rabi.csv",              # Rabi oscillation      (unitary -> holo)
}

# Expected verdict per dataset (from paper v8), for reference in the summary.
EXPECTED = {
    "mandelbrot": "holo",
    "tricorn":    "anti",
    "wm_damped":  "anti",
