...
discriminates on the structural attributes 1-4 that are readable without
any Wirtinger computation.

CALIBRATION
-----------
The sieve must re-reject the five certified walls, each for the correct
reason, and let the target survive. The self-test at the bottom enforces this.
Wall attributes below are transcribed from the research history (commits noted);
they are NOT re-certified here. If an attribute is disputed, the sieve changes.
"""

from dataclasses import dataclass, field
from typing import Optional, List

# The six necessary conditions, in report order. True is required to survive.
NECESSARY = [
...
# ---------------------------------------------------------------------------
# CALIBRATION SET: five certified walls + the target.
# ---------------------------------------------------------------------------
...
TARGET = Mechanism(
    ...
    source="master law + commit 20204b2 (cross-discriminant operational)",
)
